...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return BaseViewHolder.getRecyclerHolder(context, view);
    }
    ...
    public void onBindViewHolder(final BaseViewHolder holder, int position) {
        ...
        if (listener != null) {
            holder.itemView.setBackgroundResource(R.drawable.ic_launcher_background);//设置背景
        }
     ...
     */
    public abstract void convert(BaseViewHolder holder, T item, int position, boolean isScrolling);
}